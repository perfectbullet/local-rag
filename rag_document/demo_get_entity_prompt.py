...
def inference(
    ...
    for sentence in sentences:
        with console.status("[bold bright_green] Model Inference..."):
            ...
            cls_res = llm.invoke(sentence_with_cls_prompt, history=custom_settings['cls_pre_history'])
            ...
            ie_res, _ = llm.invoke(sentence_with_ie_prompt, history=custom_settings['ie_pre_history'])
